...
public:
    ...
    {
        listLock.lock();
        // std::cout << "Thread inserting..." << std::endl;
        /* first find position */
        node<T> *pred = nullptr;
        node<T> *succ = first;
        ...
        // std::cout << "Thread done inserting..." << std::endl;
        listLock.unlock();
    }
    ...
    void remove(T v)
    {
        /* first find position */
        listLock.lock();
        // std::cout << "Thread removing..." << std::endl;
        node<T> *pred = nullptr;
        ...
        {
            /* v not found */
            // std::cout << "Thread done removing (not found)..." << std::endl;
            listLock.unlock();
            return;
        }
        /* remove current */
        ...
        delete current;
        // std::cout << "Thread done removing..." << std::endl;
        listLock.unlock();
    }
